...
from .utils import _DINOV2_BASE_URL, _make_morphFM_model_name, CenterPadding
...
def _make_morphFM_linear_depth_head(
    *,
    embed_dim: int,
    layers: int,
    min_depth: float,
...
def _make_morphFM_linear_depther(
    *,
    ...
    **kwargs,
    ...
    linear_depth_head = _make_morphFM_linear_depth_head(
        embed_dim=embed_dim,
        layers=layers,
        min_depth=min_depth,
        max_depth=max_depth,
...
def morphFM_vits14_ld(*, layers: int = 4, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_linear_depther(
        arch_name="vit_small", layers=layers, pretrained=pretrained, weights=weights, **kwargs
    )


def morphFM_vitb14_ld(*, layers: int = 4, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_linear_depther(
        arch_name="vit_base", layers=layers, pretrained=pretrained, weights=weights, **kwargs
    )


def morphFM_vitl14_ld(*, layers: int = 4, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_linear_depther(
        arch_name="vit_large", layers=layers, pretrained=pretrained, weights=weights, **kwargs
    )


def morphFM_vitg14_ld(*, layers: int = 4, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_linear_depther(
        arch_name="vit_giant2", layers=layers, ffn_layer="swiglufused", pretrained=pretrained, weights=weights, **kwargs
    )


def _make_morphFM_dpt_depth_head(*, embed_dim: int, min_depth: float, max_depth: float):
    return DPTHead(
...
def _make_morphFM_dpt_depther(
    ...
    **kwargs,
    ...
    model_name = _make_morphFM_model_name(arch_name, backbone.patch_size)
    dpt_depth_head = _make_morphFM_dpt_depth_head(embed_dim=backbone.embed_dim, min_depth=min_depth, max_depth=max_depth)
...
def morphFM_vits14_dd(*, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_dpt_depther(arch_name="vit_small", pretrained=pretrained, weights=weights, **kwargs)


def morphFM_vitb14_dd(*, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_dpt_depther(arch_name="vit_base", pretrained=pretrained, weights=weights, **kwargs)


def morphFM_vitl14_dd(*, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_dpt_depther(arch_name="vit_large", pretrained=pretrained, weights=weights, **kwargs)


def morphFM_vitg14_dd(*, pretrained: bool = True, weights: Union[Weights, str] = Weights.NYU, **kwargs):
    return _make_morphFM_dpt_depther(
