...
from morphFM.eval.linear import get_args_parser as get_linear_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from morphFM.eval.linear import main as linear_main
...
def main():
    ...
    submit_jobs(Evaluator, args, name="morphFM:linear")
    return 0
