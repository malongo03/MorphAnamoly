...
from morphFM.eval.log_regression import get_args_parser as get_log_regression_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from morphFM.eval.log_regression import main as log_regression_main
...
def main():
    ...
    submit_jobs(Evaluator, args, name="morphFM:logreg")
    return 0
