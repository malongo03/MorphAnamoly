...
from morphFM.eval.knn import get_args_parser as get_knn_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from morphFM.eval.knn import main as knn_main
...
def main():
    ...
    submit_jobs(Evaluator, args, name="morphFM:knn")
    return 0
